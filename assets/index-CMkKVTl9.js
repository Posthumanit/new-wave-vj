 ...
 */var Te=c,ze=Symbol.for("react.element"),Me=Symbol.for("react.fragment"),je=Object.prototype.hasOwnProperty,Ce=Te.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Ee={key:!0,ref:!0,__self:!0,__source:!0};function V(n,e,s){var a,t={},r=null,i=null;s!==void 0&&(r=""+s),e.key!==void 0&&(r=""+e.key),e.ref!==void 0&&(i=e.ref);for(a in e)je.call(e,a)&&!Ee.hasOwnProperty(a)&&(t[a]=e[a]);if(n&&n.defaultProps)for(a in e=n.defaultProps,e)t[a]===void 0&&(t[a]=e[a]);return{$$typeof:ze,type:n,key:r,ref:i,props:t,_owner:Ce.current}}C.Fragment=Me;C.jsx=V;C.jsxs=V;$.exports=C;var o=$.exports,q,F=ue;q=F.createRoot,F.hydrateRoot;function Ie({onSubmit:n}){const[e,s]=c.useState(""),[a,t]=c.useState(!1),r=i=>{i.preventDefault();const l=e.trim();l&&n(l)};return o.jsx("div",{className:"fade-in",style:{maxWidth:480,width:"100%",margin:"0 auto"},children:o.jsxs("div",{className:"card",style:{display:"flex",flexDirection:"column",gap:20},children:[o.jsxs("div",{children:[o.jsx("p",{className:"label",children:"Step 1 of 3"}),o.jsx("h2",{style:{fontSize:18,fontWeight:700,letterSpacing:2,marginBottom:8},children:"GEMINI API KEY"}),o.jsxs("p",{style:{fontSize:12,color:"var(--text-dim)",lineHeight:1.6},children:["Your key is stored locally in the browser and never sent to any server. Get a free key at"," ",o.jsx("a",{href:"https://aistudio.google.com/app/apikey",target:"_blank",rel:"noopener noreferrer",style:{color:"var(--cyan)"},children:"aistudio.google.com"})]})]}),o.jsxs("form",{onSubmit:r,style:{display:"flex",flexDirection:"column",gap:12},children:[o.jsx("label",{className:"label",htmlFor:"api-key",children:"API KEY"}),o.jsxs("div",{style:{position:"relative"},children:[o.jsx("input",{id:"api-key",className:"input",type:a?"text":"password",value:e,onChange:i=>s(i.target.value),placeholder:"AIza...",autoComplete:"off",spellCheck:!1,style:{paddingRight:48}}),o.jsx("button",{type:"button",onClick:()=>t(i=>!i),style:{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",background:"none",color:"var(--text-dim)",fontSize:16,padding:4},children:a?"🙈":"👁️"})]}),o.jsx("button",{type:"submit",className:"btn btn-primary",disabled:!e.trim(),style:{opacity:e.trim()?1:.5},children:"CONTINUE →"})]})]})})}const A={mood:"energetic",energy:.7,bpm:120,genre:"electronic",colors:["#ff0080","#00ffff","#8000ff"],description:"High-energy electronic music with pulsing synthesizers",imagePrompt:"Abstract psychedelic digital art, neon pink and cyan laser beams, fractal geometry, music visualizer aesthetic, dark background, 80s synthwave"};async function Be(n,e){const s=new Y({apiKey:n}),a=`You are a music mood analyzer. Analyze this music reference: "${e}"
